...
import imgLogo from '../assets/img/logos/jumpstart.svg';
import imgIconMenu from '../assets/img/icons/interface/icon-menu.svg';
import imgIconX from '../assets/img/icons/interface/icon-x.svg';

const navbar = () => {
    
        return (
            <div class="navbar-container">
      <nav class="navbar navbar-expand-lg navbar-light bg-white" data-overlay>
        <div class="container">
          <a class="navbar-brand navbar-brand-dynamic-color fade-page" href="index.html">
            <img alt="Jumpstart" src={imgLogo}></img>
          </a>
          <div class="d-flex align-items-center order-lg-3">
            ...
            <button aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler" data-target=".navbar-collapse" data-toggle="collapse" type="button">
              <img alt="Navbar Toggler Open Icon" class="navbar-toggler-open icon icon-sm" src={imgIconMenu}></img>
              <img alt="Navbar Toggler Close Icon" class="navbar-toggler-close icon icon-sm" src={imgIconX}></img>
            </button>
          </div>
